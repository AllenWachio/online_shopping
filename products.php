...
<html>
    <head>
        ...
        <title>Allegrace Fashions Store</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Allegrace Fashions Store!!!</h1>
                    <p>We have the best sweatpants, sweatshirts, dresses, ties, watches and shirts for you. No need to hunt around, we have it all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sweatshirt1.jpg" alt="Sweatshirt lv">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sweatshirt LV</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sweatshirt2.jpg" alt="Sweatshirt Calvin Klein">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sweatshirt | Calvin Klein</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sweatshirt3.jpg" alt="Sweatshirt | Tommy ">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sweatshirt | Tommy Hilfigur</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sweatshirt4.jpg" alt="Sweatshirt | Ralph&Laureen">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sweatshirt | Ralph&Laureen</h3>
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   <p>Copyright &copy <a href="https://projectworlds.in"><b>Allegrace Fashion Store</b></a> Store. All Rights Reserved.</p>
                   <p>This website is developed by <b>Allen Kizito</b></p>
               </center>
               </div>
           </footer>
        </div>
